...
const char* ei_classifier_inferencing_categories[] = { "Snake", "Updown_2", "Wave2", "idle" };

EI_CLASSIFIER_DSP_AXES_INDEX_TYPE ei_dsp_config_12_axes[] = { 0, 1, 2 };
const uint32_t ei_dsp_config_12_axes_size = 3;
ei_dsp_config_raw_t ei_dsp_config_12 = {
    12, // uint32_t blockId
...
ei_learning_block_config_tflite_graph_t ei_learning_block_config_13 = {
    .implementation_version = 1,
...
const uint32_t ei_learning_block_14_inputs[1] = { 12 };
...
const ei_impulse_t impulse_738583_0 = {
    .project_id = 738583,
    .project_owner = "isat",
    .project_name = "Impulse classification",
    .impulse_id = 1,
    .impulse_name = "Impulse #1",
    .deploy_version = 2,

    .nn_input_frame_size = 150,
    .raw_sample_count = 50,
...
ei_impulse_handle_t impulse_handle_738583_0 = ei_impulse_handle_t( &impulse_738583_0 );
ei_impulse_handle_t& ei_default_impulse = impulse_handle_738583_0;
